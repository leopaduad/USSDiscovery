...
namespace USSDiscovery.API
{
    public class Startup
    {
        ...
        {            
            services.AddDbContext<USSDiscoveryContext>(options => 
                    options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));

            services.AddTransient<IPlanetaRepository, PlanetaRepository>();
            services.AddTransient<IPlanetaService, PlanetaService>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "USSDiscovery API V1");
